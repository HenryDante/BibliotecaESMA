    ...
    function subirImagen($archivo, $dir, $conexion){     
        ...
        if($_FILES[$archivo]["type"] == "image/jpeg"){
            ...
            if ($_FILES[$archivo]["error"]) {
                ...
                if(!is_dir("biblioteca-virtual/administrador/imagenes/".$dir)){
                    mkdir("biblioteca-virtual/administrador/imagenes/".$dir, 0755);
                }

                // Comprobamos que no haya ningun archivo con el mismo nombre en el servidor.
                if (file_exists("biblioteca-virtual/administrador/imagenes/".$dir."/".$_FILES[$archivo]["name"])) {
