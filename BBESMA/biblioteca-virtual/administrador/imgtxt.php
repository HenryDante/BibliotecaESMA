...
<form action="imgtxt.php" enctype=multipart/form-data name="home"  method="post">


   <h1> Banner en Inicio </h1><br>
    </div>


      <div><br> <img width="510px" height="330px"  src="<?php echo $imaini;?>"/>      </div>
      <br><input type="file" name="img1" />
      <div> 
     <br>
      <h1> Texto / Noticia Personalizado en Inicio   </h1><br>  <br>
     <textarea style="border: none;" disabled name="noti1" cols="60" rows="7"><?php echo $notie1;?></textarea>
  ...
  if(isset($_REQUEST['actualizar']))
{
        echo "<script language='JavaScript'>
            ...
            window.location.href='imgtxt.php';
            </script>";
 ...
 if (isset ($_FILES["img1"])) {
    ...
    if (!copy($tmp_name,"$newfile")) {   
     ...
     mysql_query("UPDATE home SET imgi = '$img1'") or die(mysql_error());
...
mysql_query("UPDATE home SET txtn = '$noti1'") or die(mysql_error());
}
?>
